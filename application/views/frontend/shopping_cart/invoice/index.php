                    ...
                    <div class="invoice_body">
                        <div class="invoice-title">
                            <div class="invoice_logo hidden-xs">
                                ...
                                ?>
                                <img
                                    src="<?php echo base_url(); ?>uploads/logo_image/logo_88.png"
                                    alt="SuperShop"/>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <address>
                                    ...
                                    <p>
                                        ...
                                        <?php echo translate('e-mail'); ?> : <a
                                            href=""><?php echo $info['email']; ?></a>
                                    </p>
                                </address>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><strong><?php echo translate('payment_invoice'); ?></strong>
                                </h3>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-condensed table-invoice">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><strong><?php echo translate('item'); ?></strong>
                                            </td>
                                            <td class="text-center"><strong><?php echo translate('options'); ?></strong>
                                            </td>
                                            <td class="text-right"><strong><?php echo translate('quantity'); ?></strong>
                                            </td>
                                            <td class="text-right">
                                                <strong><?php echo translate('unit_cost'); ?></strong></td>
                                            <td class="text-right"><strong><?php echo translate('total'); ?></strong>
                                            </td>
                                        </tr>
                                        </thead>
                                        <tbody>
