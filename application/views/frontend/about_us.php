        ...
        <div class="terms-conditions-page">
            <div class="row">
                <div class="col-md-12 terms-conditions">
                    <h2 class="heading-title">About Technology Revolution</h2>
                    <div class="">
            ...
            <div class="logo-slider-inner">
                <div id="brand-slider" class="owl-carousel brand-slider custom-carousel owl-theme">
                    <div class="item m-t-15">
                        <a href="#" class="image">
                            <img data-echo="<?= base_url()?>frontend_assets/images/brands/brand1.png" src="<?= base_url()?>frontend_assets/images/blank.gif" alt="">
                        </a>
                    </div><!--/.item-->

                    <div class="item m-t-10">
                        <a href="#" class="image">
                            <img data-echo="<?= base_url()?>frontend_assets/images/brands/brand2.png" src="<?= base_url()?>frontend_assets/images/blank.gif" alt="">
                        </a>
                    </div><!--/.item-->

                    <div class="item">
                        <a href="#" class="image">
                            <img data-echo="<?= base_url()?>frontend_assets/images/brands/brand3.png" src="<?= base_url()?>frontend_assets/images/blank.gif" alt="">
                        </a>
                    </div><!--/.item-->

                    <div class="item">
                        <a href="#" class="image">
                            <img data-echo="<?= base_url()?>frontend_assets/images/brands/brand4.png" src="<?= base_url()?>frontend_assets/images/blank.gif" alt="">
                        </a>
                    </div><!--/.item-->

                    <div class="item">
                        <a href="#" class="image">
                            <img data-echo="<?= base_url()?>frontend_assets/images/brands/brand5.png" src="<?= base_url()?>frontend_assets/images/blank.gif" alt="">
                        </a>
                    </div><!--/.item-->

                    <div class="item">
                        <a href="#" class="image">
                            <img data-echo="<?= base_url()?>frontend_assets/images/brands/brand6.png" src="<?= base_url()?>frontend_assets/images/blank.gif" alt="">
                        </a>
                    </div><!--/.item-->
