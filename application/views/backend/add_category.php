            ...
            <div style="left: 50%; transform: translateX(-50%);" class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <strong><span class="icon icon-plus-circle"></span> ADD CATEGORY</strong>
                    </div>
                    <div class="card-body">
                        <div id="msg"></div>
                        <form id="add_category" class="form form-horizontal" style="margin-top: 30px" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="text"  name="icon" id="icon" placeholder="Font Icon Class">
                                    </div>
                                </div>
                            </div>
