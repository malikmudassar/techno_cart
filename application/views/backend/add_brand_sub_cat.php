                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="add_sub_cat" class="form form-horizontal" style="margin-top: 30px" method="POST">
                            ...
                            <div class="form-group">
                                <label for="username" class="col-sm-3 control-label" style="width: 20%;" for="form-control-17">Brand</label>
                                <div class="col-sm-9">
                                    <select id="demo-select2-2" class="form-control" name="brand_id">
                                        <option value="0">Select brand</option>
                                        <?php
                                        if (count($brand) > 0) {
                                            for ($i = 0; $i < count($brand); $i++) {
                                                ?>
                                                <option value="<?php echo $brand[$i]['id'] ?>"><?php echo $brand[$i]['name'] ?></option>
                                                <?php
                                            }
                                        }
                                        ?>
